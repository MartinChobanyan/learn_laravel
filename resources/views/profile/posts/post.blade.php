<div id="{{ $post->id }}" class="card card-body bg-faded mb-2">
    <div class="media">
        <div id="post-photo" class="pull-left mr-1" style="width:250;height:250;background-image:url({{ asset('post/image/'.$post->id) }});background-size:cover;background-repeat:no-repeat;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
